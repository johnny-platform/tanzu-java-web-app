...
```json
{
  "projectName" : "tanzu-java-web-app-jp",
  "repositoryPrefix" : "tapdemokb8.azurecr.io/supply-chain"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->tapdemokb8.azurecr.i...(truncated)]
